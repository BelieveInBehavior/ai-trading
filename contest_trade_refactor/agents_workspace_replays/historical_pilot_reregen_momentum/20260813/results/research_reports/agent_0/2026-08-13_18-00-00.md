  ...
  "signals": [
    {
      ...
      "evidence_list": [
        {
          "description": "当日主力资金净流入17.71亿元，3日累计净流入49.13亿元，5日累计净流入45.49亿元，连续多日资金持续进场，显示机构及主力资金高度看好。",
          "time": "2026-08-13 18:00:00",
          "from_source": "individual_fund_flow_agent"
        },
        {
          "description": "CPO概念板块当日主力资金净流入132.76亿元，居所有概念板块首位，光通信产业链（CPO、F5G、光纤）形成高度集中的资金主线，中际旭创作为光模块龙头将显著受益。",
          "time": "2026-08-13 18:00:00",
          "from_source": "sector_fund_flow_trend_agent"
        },
        {
          "description": "热钱市场分析显示机构重点买入方向集中于光通信/PCB产业链，机构与游资在光通信产业链上形成合力，中际旭创作为板块核心标的获资金共振推动。",
          "time": "2026-08-13 18:00:00",
          "from_source": "hot_money_agent"
        },
        {
          "description": "技术面上股价站上MA5（909.48）和MA10（918.56），短期均线走平并小幅上穿，MACD下跌动能边际减弱，短期存在技术性反弹需求。",
          "time": "2026-08-13 18:00:00",
          "from_source": "technical_indicators_agent"
        }
      ],
      "limitations": [
        "中期均线MA20（约977元）构成强压力，若无法有效突破则反弹空间受限。",
        "该股单日振幅常超6%，高波动性带来较大回撤风险，需严格设置止损。",
        "全球AI资本开支预期波动及A/H溢价变化可能引发剧烈波动。"
      ],
      "probability": 0.72
    }
  ]
