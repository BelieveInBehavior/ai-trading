  ...
  "signals": [
    {
      ...
      "evidence_list": [
        {
          "description": "中际旭创当日主力净流入17.71亿元，3日累计净流入49.13亿元，5日累计净流入45.49亿元，连续多日主力资金持续大幅进场，资金共识极强。",
          "time": "2026-07-20 18:00:00",
          "from_source": "individual_fund_flow_agent"
        },
        {
          "description": "通信设备行业板块当日主力净流入117.55亿元居全行业首位，CPO概念板块主力净流入132.76亿元，中际旭创作为光模块龙头充分受益于板块资金合力。",
          "time": "2026-07-20 18:00:00",
          "from_source": "sector_fund_flow_trend_agent"
        },
        {
          "description": "当日涨幅仅+2.38%，与17.39亿元主力净流入规模明显不匹配，呈现典型的主力吸筹特征，股价尚未充分反映资金流入强度。",
          "time": "2026-07-20 18:00:00",
          "from_source": "individual_fund_flow_agent"
        },
        {
          "description": "热钱市场报告显示CPO概念主力净流入132.76亿元为全市场概念板块第一，机构与游资在光通信方向形成共振，短线交易情绪处于偏暖区间。",
          "time": "2026-07-20 18:00:00",
          "from_source": "hot_money_agent"
        }
      ],
      "limitations": [
        "技术面仍处空头排列，MACD负柱扩大，中期下行趋势尚未反转，反弹持续性存疑。",
        "股价已从历史高点回撤约29%，若布林下轨975.91元被有效跌破可能引发新一轮下探。",
        "光模块产品2027年价格谈判存在降价预期，市场对此担忧尚未完全消化。"
      ],
      "probability": 0.68
    }
  ]
