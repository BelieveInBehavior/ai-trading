  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: "0.75rem", color: "#94a3b8", display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
        ...
        {signal.probability != null && <span>Probability: {signal.probability}</span>}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            ...
            >
              ...
              >
                ...
                <StatCard value={result.best_signals.length} label="Best Signals" color="#f59e0b" />
              </div>
            </section>

            {/* signals */}
            {result.best_signals.length > 0 && (
              <section
                style={{
                  background: "white",
                  border: "1px solid #e2e8f0",
              ...
              >
                <div style={{ fontWeight: 600, marginBottom: "1rem", fontSize: "0.9rem" }}>
                  Trading Signals ({result.best_signals.length})
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: "0.55rem" }}>
                  {result.best_signals.map((signal, i) => (
